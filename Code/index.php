...
<!-- article end -->
    <section id="gallery">
        <div class="container">
            <div class="title text text-center mb-4 mt-5">
                <h1 class="fw-bold">Gallery</h1>
                <p class="text-secondary">Ini Adalah Gallery</p>
            </div>
                ...
                <div class="col-12 col-md-4 col-lg-3">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                          <h5 class="card-title fw-bold">Ngopi</h5>
                          <p class="card-text text-secondary">Sebelum Berangkat</p>
                        </div>
                      </div>
                </div>
                <div class="col-12 col-md-4 col-lg-3">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                          <h5 class="card-title fw-bold">Seminar</h5>
                          <p class="card-text text-secondary">Kegiatan dikampus</p>
                        </div>
                      </div>
                </div>
                <div class="col-12 col-md-4 col-lg-3">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                          <h5 class="card-title fw-bold">Istirahat</h5>
                          <p class="card-text text-secondary">Mau Beli Mam Dulu</p>
                        </div>
                      </div>
                </div>
                <div class="col-12 col-md-4 col-lg-3">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                          <h5 class="card-title fw-bold">Foto Bareng</h5>
                          <p class="card-text text-secondary">Dokumentasi Gasiii?</p>
                        </div>
                      </div>
                </div>
                <div class="col-12 col-md-4 col-lg-3">
                  <div class="card">
                      ...
                      <div class="card-body text-center">
                        <h5 class="card-title fw-bold">Perjalanan Pulang</h5>
                        <p class="card-text text-secondary">Pulang Kerumah Bobo</p>
                      </div>
                    </div>
              </div>
            </div>
    ...
    <footer class="p-4 bg-light text-center mt-5">Copyright © 2024 Naban Journal Gallery. All Rights Reserved</footer>
    <script
